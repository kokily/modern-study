...
const FooterRight = () => (
  <div className="col-lg-3 col-md-6">
    ...
    <div className="text-light-gray margin-20px-bottom">
      <KakaoMap>
        <KakaoImage>
          <a href="https://map.kakao.com/?urlX=456100.0&amp;urlY=1093784.0&amp;name=%EA%B2%BD%EA%B8%B0%20%EC%8B%9C%ED%9D%A5%EC%8B%9C%20%EC%9D%80%EA%B3%84%EB%B2%88%EC%98%81%EA%B8%B8%205&amp;map_type=TYPE_MAP&amp;from=roughmap">
            <img
              className="map"
        ...
        <KakaoLeft>
          <a href="https://map.kakao.com" style={{ float: 'left' }}>
            <img
